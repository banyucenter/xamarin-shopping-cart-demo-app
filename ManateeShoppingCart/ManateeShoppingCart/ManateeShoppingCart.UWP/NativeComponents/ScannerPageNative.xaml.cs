    ...
    public sealed partial class ScannerPageNative : Page
    {
        ...
        private async void addOverLay()
        {
            try
            {
                ...
                if (overlayMode == (int)OverlayMode.OM_IMAGE)
                {
                    ...
                    BitmapImage BitImg = new BitmapImage(new Uri(this.BaseUri, "ms-appx:///Images/overlay_mw.png"));
        ...
        private void TorchCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            ...
            if (flashOnOff == false)
            {
                ...
                BitmapImage bmp = new BitmapImage();
                Uri u = new Uri(this.BaseUri, "ms-appx:///Images/flashbuttonon.png");
                bmp.UriSource = u;
            ...
            else
            {
                ...
                BitmapImage bmp = new BitmapImage();
                Uri u = new Uri(this.BaseUri, "ms-appx:///Images/flashbuttonoff.png");
                bmp.UriSource = u;
                // NOTE: change starts here
                Image i = new Image();
                i.Source = bmp;
